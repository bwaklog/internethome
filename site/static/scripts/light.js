function lightScheme() {
  ...
  document.documentElement.style.setProperty("--color-text-low", "#10100e20");
  ...
  document.documentElement.style.setProperty("--inline-code-bg", "#f9f8f9");
  document.documentElement.style.setProperty(
...
function darkScheme() {
  ...
  document.documentElement.style.setProperty("--color-text", "#ffffffc0");
  document.documentElement.style.setProperty("--color-text-dim", "#ffffff5a");
  document.documentElement.style.setProperty("--color-text-low", "#ffffff19");
  ...
  document.documentElement.style.setProperty("--color-background", "#0b0c0d");
  ...
  document.documentElement.style.setProperty("--inline-code-bg", "#161618");
  document.documentElement.style.setProperty(
    "--color-background-contrast",
    "#1a1a1a",
  );
